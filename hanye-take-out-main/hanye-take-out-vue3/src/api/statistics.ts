...
export const getOrderStatisticsAPI = (params: any) => {
  return request({
    url: `/admin/report/orderStatistics`,
    method: 'get',
    params
  })
}
...
export const getTop10StatisticsAPI = (params: any) => {
  return request({
    url: `/admin/report/top10Statistics`,
    method: 'get',
    params
  })
}
...
export const getDataesAPI = (params: any) => {
  return request({
    url: `/admin/report/dayCollect/${params.date}`,
    method: 'get'
  })
}
...
export const getChartsDataesAPI = (params: any) => {
  return request({
    url: `/admin/report/dayCollect/${params.start}/${params.end}`,
    method: 'get'
  })
}
...
export const getDayDataesAPI = (params: any) => {
  return request({
    url: `/admin/report/hourCollect/${params.type}/${params.date}`,
    method: 'get'
  })
}
...
export const getDayPayTypeAPI = (params: any) => {
  return request({
    url: `/admin/report/payTypeCollect/${params.date}`,
    method: 'get'
  })
}
...
export const getprivilegeAPI = (params: any) => {
  return request({
    url: `/admin/report/privilegeCollect/${params.date}`,
    method: 'get'
  })
}
...
export const getSalesRankingAPI = (params: any) => {
  return request({
    url: `/admin/report/categoryCollect/${params.type}/${params.date}`,
    method: 'get'
  })
}
...
export const getDayRankingAPI = (params: any) => {
  return request({
    url: `/admin/report/currentDishRank/${params.date}`,
    method: 'get'
  })
}
...
export const getTimeQuantumDataesAPI = (params: any) => {
  return request({
    url: `/admin/report/dayAmountCollect/${params.type}/${params.start}/${params.end}`,
    method: 'get'
  })
}
...
export const getTimeQuantumReceivablesAPI = (params: any) => {
  return request({
    url: `/admin/report/datePayTypeCollect/${params.start}/${params.end}`,
    method: 'get'
  })
}
...
export const getTimeQuantumTypeAPI = (params: any) => {
  return request({
    url: `/admin/report/dateCategoryCollect/${params.type}/${params.start}/${params.end}`,
    method: 'get'
  })
}
...
export const getTimeQuantumDishesAPI = (params: any) => {
  return request({
    url: `/admin/report/dishRankForDate/${params.start}/${params.end}`,
    method: 'get'
  })
}
...
export const getTimeQuantumDiscountAPI = (params: any) => {
  return request({
    url: `/admin/report/privilegeByDate/${params.start}/${params.end}`,
    method: 'get'
  })
}
