  ...
  <div class="common-layout">
    ...
    <el-container>
      ...
      <el-container class="box1">
        <!-- 左侧导航菜单区域 -->
<el-menu :width="isCollapse ? '640px' : '200px'" :default-active="currentActive" :collapse="isCollapse"
          background-color="#22aaee" text-color="#fff" unique-opened @select="handleMenuSelect">
